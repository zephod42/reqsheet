...
Security is a design requirement from the beginning. This foundation has no authentication, user data, or application-domain tables. It has a lazy PDO connection, a generic database health response, and a migration CLI.
