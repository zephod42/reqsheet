        ...
        if ($method === 'POST') {
            try {
                ...
                if ($this->handoffs !== null && $this->baseHost !== '') {
                    ...
                    SessionAuth::logout();
                    return '<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/assets/app.css"><title>Reqsheet setup</title><main>' . PageLayout::alphaBanner() . '<meta http-equiv="refresh" content="0;url=' . $this->e($destination) . '"><p>Continuing to the school recovery-key setup…</p></main>';
                }
                return '<!doctype html><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/assets/app.css"><title>Reqsheet setup complete</title><main>' . PageLayout::alphaBanner() . '<h1>Setup complete</h1><p>The first account is ready. <a href="/login">Continue to login</a>.</p></main>';
