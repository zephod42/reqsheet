...
final class SettingsPage
{
    ...
    {
        return "document.addEventListener('click',function(event){var target=event.target;if(target.matches('[data-add-room]')){var t=document.getElementById('room-template');document.querySelector('[data-rooms]').insertAdjacentHTML('beforeend',t.innerHTML);}if(target.matches('[data-add-separator]')){var t=document.getElementById('separator-template');var html=t.innerHTML.replaceAll('After period 1','After period 1');document.querySelector('[data-separators]').insertAdjacentHTML('beforeend',html);}if(target.matches('[data-remove]')){var parent=target.closest('label')||target.closest('[data-separators] > div');if(parent)parent.remove();}});";
    }
