...
final class HowToPage
{
    public static function render(string $section, array $user): string
    {
        ...
        elseif ($section === 'administrator') $content .= self::administrator($image) . '<section class="how-to-section"><h2>Technician highlighting</h2><p>In Settings, administrators can enable Technician highlighting, choose one to five fixed light colours, and enter a school-defined label beside each enabled colour. Turning it off hides technician controls and backgrounds without changing prepared status. Reducing the number of colours clears only highlights using removed colours.</p></section>';
