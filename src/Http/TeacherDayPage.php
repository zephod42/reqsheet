...
final class TeacherDayPage
{
    ...
    public function handle(string $method, array $query = [], array $input = []): string
    {
        ...
        return PageLayout::render('Teacher day', $body . $this->inlineEditingScript(), $this->user);
    }
